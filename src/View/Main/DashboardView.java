...
public class DashboardView extends JFrame {
  ...
  public DashboardView() {
    ...
    System.out
        .println("Usuario en sesión: " + user.getFirstName() + " " + user.getLastName() + " (" + user.getEmail() + ")");
    ...
    // HTML is used to give the desired formatting to the text within a Swing
    // component.
  ...
  private class MenuCard extends JPanel {
    ...
    public MenuCard(String title, String imgPath) {
      ...
      if (checkIcon.getIconWidth() == -1) {
        checkIcon = new ImageIcon("assets/images/Menu/default.png");
      }
