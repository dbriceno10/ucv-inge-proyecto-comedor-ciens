...
public class RegisterUserTest {
    ...
    public void testRegisterUser() {
        ...
        AuthUserDto registeredUser = authService.register(email, UserRoles.COMMENSAL, firstName, lastName, password, repeatPassword, documentId);
        ...
        // 3. Intentar registrarlo nuevamente (Debe fallar porque el email ya está en uso)
